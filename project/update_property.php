...
if(isset($_POST['update'])){
   ...
   $update_listing = $conn->prepare("UPDATE `property` SET property_name = ?, address = ?, price = ?, type = ?, offer = ?, status = ?, furnished = ?, deposite = ?, bedroom = ?, bathroom = ?, carpet = ?, lift = ?, security_guard = ?, water_supply = ?, power_backup = ?,  description = ? WHERE id = ?");   
   $update_listing->execute([$property_name, $address, $price, $type, $offer, $status, $furnished, $deposite, $bedroom, $bathroom, $carpet, $lift, $security_guard, $water_supply, $power_backup, $description, $update_id]);
...
<section class="property-form">
   ...
   <form action="" method="POST" enctype="multipart/form-data">
      ...
      <div class="box">
         <p>Name <span>*</span></p>
         <input type="text" name="property_name" required maxlength="50" placeholder="Name" value="<?= $fetch_property['property_name']; ?>" class="input">
      </div>
      <div class="flex">
         <div class="box">
            <p>Price <span>*</span></p>
            <input type="number" name="price" required min="0" max="9999999999" maxlength="10" value="<?= $fetch_property['price']; ?>" placeholder="Enter price rate" class="input">
         </div>
         <div class="box">
            <p>Deposit amount <span>*</span></p>
            <input type="number" name="deposite" required min="0" max="9999999999" value="<?= $fetch_property['deposite']; ?>" maxlength="10" placeholder="Enter amount" class="input">
         </div>
         <div class="box">
            <p>Location <span>*</span></p>
            <input type="text" name="address" required maxlength="100" placeholder="Enter Location" class="input" value="<?= $fetch_property['address']; ?>">
         </div>
         <div class="box">
            <p>Rent Offer Type <span>*</span></p>
         ...
         <div class="box">
            ...
            <select name="bedroom" required class="input">
               <option value="<?= $fetch_property['bedroom']; ?>" selected><?= $fetch_property['bedroom']; ?> Room</option>
         ...
         <div class="box">
            ...
            <select name="bathroom" required class="input">
               <option value="<?= $fetch_property['bathroom']; ?>" selected><?= $fetch_property['bathroom']; ?> Locker</option>
         ...
         <div class="box">
            ...
            <select name="balcony" required class="input">
               <option value="<?= $fetch_property['balcony']; ?>" selected><?= $fetch_property['balcony']; ?> Storeroom</option>
         ...
         <div class="box">
            ...
            <input type="number" name="carpet" required min="1" max="9999999999" maxlength="10" placeholder="how many squarefts?" class="input" value="<?= $fetch_property['carpet']; ?>">
         </div>
      </div>
      <div class="box">
         <p>Space Description <span>*</span></p>
         <textarea name="description" maxlength="1000" class="input" required cols="30" rows="10" placeholder="Describe your space..." ><?= $fetch_property['description']; ?></textarea>
      </div>
      <div class="checkbox">
         <div class="box">
