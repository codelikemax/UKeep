...
<section class="listings">
   ...
   <h1 class="heading">Saved Spaces</h1>
   ...
   <div class="box-container">
      ...
      <form action="" method="POST">
         <div class="box">
            ...
            ?>
            <button type="submit" name="save" class="save"><i class="fas fa-bookmark"></i><span>Remove</span></button>
            <?php
               }else{ 
            ?>
      ...
      <?php
               ...
               echo '<p class="empty">No Spaces Added yet! <a href="post_property.php" style="margin-top:1.5rem;" class="btn">Add Space</a></p>';
            }
         }
      }else{
         echo '<p class="empty">No Saved Spaces! <a href="listings.php" style="margin-top:1.5rem;" class="btn">Explore!</a></p>';
      }
      ?>
