...
<section class="listings">
   ...
   <div class="box">
      ...
      <p class="price"><i class="fas fa-cedi-sign"></i><?= $fetch_listing['price']; ?></p>
      ...
      <form action="" method="POST">
         ...
         <a href="aview_property.php?get_id=<?= $listing_id; ?>" class="btn">View Space</a>
   ...
   <?php
         ...
         echo '<p class="empty">No spaces posted!</p>';
      }
   ?>
