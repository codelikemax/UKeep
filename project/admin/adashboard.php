...
<section class="dashboard">
   ...
   <div class="box">
      ...
      <a href="aupdate.php" class="btn">Update profile</a>
   </div>
   ...
   <div class="box">
      ...
      <p>Spaces Listed</p>
      <a href="alistings.php" class="btn">View Listings</a>
   </div>
   ...
   <div class="box">
      ...
      <h3><?= $count_users; ?></h3>
      <p>Users</p>
      <a href="ausers.php" class="btn">View Users</a>
   </div>
   ...
   <div class="box">
      ...
      <p>New Messages</p>
      <a href="amessages.php" class="btn">View Messages</a>
   </div>
