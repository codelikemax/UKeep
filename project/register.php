...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="tel" name="name" required maxlength="50" placeholder="Name" class="box">
      <input type="email" name="email" required maxlength="50" placeholder="Email" class="box">
      <input type="number" name="number" required min="0" max="9999999999" maxlength="10" placeholder="Number" class="box">
